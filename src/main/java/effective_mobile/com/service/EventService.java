    ...
    public List<Event> getUpcomingEvents(String city, String type) {
        ...
        for (var element : elements) {
            var slot = Event.builder()
                    ...
                    .childAge(Integer.parseInt(getValueFromProperty(element, "PROPERTY_109")))
                    ...
                    .kidCapacity(Integer.parseInt(getValueFromProperty(element, "PROPERTY_107")))
                    .slotsLeft(element.path("PROPERTY_131").asInt())
                    .adultSlotsLeft(element.path("PROPERTY_111").asInt())
                    .kidSlotsLeft(element.path("PROPERTY_129").asInt())
                    .gatheringType("type")
